                            ...
                            <div class="input-group  col-sm-6 pull-right form-group" id='pickfiles'>
                                <div class="col-sm-3 padding-item">
                                    <select class="form-control " name="status">
                                        ...
                                        <option value="8" <?php if($status == 8): ?>selected<?php endif; ?>>热门推荐</option>
                                    </select>
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="gradeX" url="<?php echo ($item["url"]); ?>">
                                    ...
                                    <td align="left" title="<?php echo ($item["title"]); ?>">
                                        ...
                                        <div style="float: left; clear: both; margin: 6px 0; line-height: 22px; font-size: 12px"><span style="background: red; padding: 5px 10px; color: #fff; border-radius: 10px; font-size: 11px;"><?php if($item[active_id]): ?>我要上电视<?php else: ?>用户上传<?php endif; ?></span> <span style="color: #999"><?php echo date("Y-m-d H:i",$item['create_time']);?></span></div>
                                    </td>
                                    ...
                                    <td><?php echo get_video_status($item[status]);?> <?php if($item['is_hot'] == 1): ?><font color="red" >[推荐]</font><?php endif; ?></td>
                                    <td align="center">
                                    ...
                                    <td class="center" style="white-space: nowrap;">
                                        ...
                                        <?php if(0 == $item[status]): ?>转码中...
                                            ...
                                            <?php if($role < 2): ?><a href="<?php echo U('/short_video/edit', array('id'=>$item['id']));?>" >编辑</a><?php endif; ?>
