            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <!--<a href="<?php echo U('/shop_cate/edit');?>" target="_self" class="btn" style="background: #e00214;color: #fff;">添加banner</a>-->
                        </div>
                    </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap; text-align: center">
                                    <button type="button" class="btn" id="delete-shop_cate" style="background: #e00214;color: #fff;">删除</button>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><td><?php echo (mb_substr($item["name"],0,30)); ?></td>
                                    ...
                                    <td class="center " style="white-space: nowrap; ">
                                        <a href="<?php echo U( '/shop_cate/edit', array( 'id'=>$item['id']));?>"><i class="fa fa-check text-navy"></i> 编辑</a>
                                    </td>
...
<script src="/Public/js/active-msdt.js?v=1.0.0"></script>
    ...
    <script type="text/javascript">
        $('select[name="search"]').change(function() {
            window.location.href = "<?php echo U('/shop_cate/index');?>&class=" + $(this).val();
        });

        $("#delete-shop_cate").click(function() {
            if (!confirm("确定要删除吗？")) {
                return false;
            }
            ...
            window.location.href = "/index.php?s=/shop_cate/delete/list/" + idList.toString() + ".html";
        });
    </script>
