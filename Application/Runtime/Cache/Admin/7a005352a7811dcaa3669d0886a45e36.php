            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <div class=""> <a href="<?php echo U('/short_video_admin/edit');?>" target="_self" class="btn" style="background: #e00214;color: #fff;">添加帐号</a>
                    ...
                    <table class="table table-striped table-bordered table-hover " id="editable">
                        ...
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="gradeX" id="<?php echo ($item["id"]); ?>">
                                    ...
                                    <td>
                                        <?php if('0' == $item[role]): ?>超级管理
                                            <?php elseif(1 == $item[role]): ?> 系统管理员
                                            <?php elseif(2 == $item[role]): ?> PGC账户个人
                                            <?php elseif(3 == $item[role]): ?> PGC账户公司
                                            <?php elseif(4 == $item[role]): ?> OGC账户
                                            <?php elseif(5 == $item[role]): ?> 栏目组账户<?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if(1 == $item[role]): echo getTvName($item['tv_id'])['tv_name']; endif; ?>
                                    </td>
