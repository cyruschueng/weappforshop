...
(function ($) {
    NProgress.configure({
        template: '<div class="bar" role="bar" style="background: LimeGreen"><div class="peg" style="box-shadow: 0 0 10px #fff, 0 0 5px #fff;"></div></div><div class="spinner" role="spinner"><div class="spinner-icon" style="border-top-color:white;border-left-color: red"></div></div>'
    });
            ...
            bootbox.dialog({
                ...
                buttons: {
                    "确定": {
                        ...
                        callback: function () {
                            $(obj).parent().parent().find('input').val(selectedImage.url);
